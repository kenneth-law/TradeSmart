...
def index():
    ...
    # Get intraday data for ASX 200 K chart with force_refresh=True to ensure latest data
    asx200_intraday = get_intraday_data("^AXJO", interval="15m", days=2, force_refresh=True)
...
def api_asx200_intraday():
    ...
    try:
        # Get intraday data for ASX 200 with force_refresh=True to ensure latest data
        asx200_intraday = get_intraday_data("^AXJO", interval="15m", days=2, force_refresh=True)
