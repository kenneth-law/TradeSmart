...
const QUICK_NAV = [
  { label: 'Backtest',          to: '/backtest',   key: '2' },
  { label: 'Integrated System', to: '/integrated', key: '3' },
    ...
    <div className="p-4 max-w-3xl mx-auto">
      ...
      <section aria-labelledby="analysis-heading">
        <div className="flex items-center justify-between mb-2">
          <h1 id="analysis-heading" className="text-sm text-text font-medium uppercase tracking-wide">
            Stock Analysis
          </h1>
      ...
      <section aria-labelledby="nav-heading">
        <h2 id="nav-heading" className="text-2xs text-dim uppercase tracking-wide mb-2">
          Tools
        </h2>
