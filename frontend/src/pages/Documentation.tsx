    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-6 max-w-4xl">
        ...
        {data && (
          <>
            {data.title && (
              <h1 className="text-base text-text font-medium uppercase tracking-wide mb-4 border-b border-border pb-2">
                {data.title}
              </h1>
            )}
            <div
      ...
      <style>{`
        .prose-terminal h1, .prose-terminal h2, .prose-terminal h3 {
          color: #E6E6E6; font-size: 13px; text-transform: uppercase;
        ...
        .prose-terminal th {
          background: #16161A; color: #5A5A63; text-transform: uppercase;
